...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sUyIYGFWnTE5Rk/ONDviVw
# These lines were loaded from './Shop/Schema/Result/Store.pm' found in @INC.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LpnROUz4xuMSbBXHcg98iA


# You can replace this text with custom code or comments, and it will be preserved on regeneration
1;
# End of lines loaded from './Shop/Schema/Result/Store.pm' 
